...
tibble_metadata <- tibble_metadata %>%
                    ...
                    filter(release_date >= ymd(19950101), release_date < ymd(20200101))
...
movie_data_genre <- mutate(movie_data_genre, earnings_rate = revenue/budget) %>% filter(earnings_rate < 500)
...
png("related_works1.png", width = 3000, height = 1000)
